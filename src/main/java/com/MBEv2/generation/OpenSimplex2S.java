    ...
    private static float noise3_UnrotatedBase(long seed, double xr, double yr, double zr) {
        ...
        if (a2 > 0) {
            ...
            value += (a2 * a2) * (a2 * a2) * grad(seed,
                    xrbp + (~xNMask & PRIME_X), yrbp + (yNMask & PRIME_Y), zrbp + (zNMask & PRIME_Z), x2, y0, z0);
        }
        else
        {
            ...
            if (a3 > 0) {
                ...
                value += (a3 * a3) * (a3 * a3) * grad(seed,
                        xrbp + (xNMask & PRIME_X), yrbp + (~yNMask & PRIME_Y), zrbp + (~zNMask & PRIME_Z), x0, y3, z3);
            }
            ...
            if (a4 > 0) {
                ...
                value += (a4 * a4) * (a4 * a4) * grad(seed2,
                        xrbp + (xNMask & (PRIME_X * 2)), yrbp + PRIME_Y, zrbp + PRIME_Z, x4, y1, z1);
                skip5 = true;
            }
        }
        ...
        if (a6 > 0) {
            ...
            value += (a6 * a6) * (a6 * a6) * grad(seed,
                    xrbp + (xNMask & PRIME_X), yrbp + (~yNMask & PRIME_Y), zrbp + (zNMask & PRIME_Z), x0, y6, z0);
        }
        else
        {
            ...
            if (a7 > 0) {
                ...
                value += (a7 * a7) * (a7 * a7) * grad(seed,
                        xrbp + (~xNMask & PRIME_X), yrbp + (yNMask & PRIME_Y), zrbp + (~zNMask & PRIME_Z), x7, y0, z7);
            }
            ...
            if (a8 > 0) {
                ...
                value += (a8 * a8) * (a8 * a8) * grad(seed2,
                        xrbp + PRIME_X, yrbp + (yNMask & (PRIME_Y << 1)), zrbp + PRIME_Z, x1, y8, z1);
                skip9 = true;
            }
        }
        ...
        if (aA > 0) {
            ...
            value += (aA * aA) * (aA * aA) * grad(seed,
                    xrbp + (xNMask & PRIME_X), yrbp + (yNMask & PRIME_Y), zrbp + (~zNMask & PRIME_Z), x0, y0, zA);
        }
        else
        {
            ...
            if (aB > 0) {
                ...
                value += (aB * aB) * (aB * aB) * grad(seed,
                        xrbp + (~xNMask & PRIME_X), yrbp + (~yNMask & PRIME_Y), zrbp + (zNMask & PRIME_Z), xB, yB, z0);
            }
            ...
            if (aC > 0) {
                ...
                value += (aC * aC) * (aC * aC) * grad(seed2,
                        xrbp + PRIME_X, yrbp + PRIME_Y, zrbp + (zNMask & (PRIME_Z << 1)), x1, y1, zC);
                skipD = true;
            }
        }
        ...
        if (!skip5) {
            ...
            if (a5 > 0) {
                ...
                value += (a5 * a5) * (a5 * a5) * grad(seed2,
                        xrbp + PRIME_X, yrbp + (yNMask & (PRIME_Y << 1)), zrbp + (zNMask & (PRIME_Z << 1)), x1, y5, z5);
            }
        }
        ...
        if (!skip9) {
            ...
            if (a9 > 0) {
                ...
                value += (a9 * a9) * (a9 * a9) * grad(seed2,
                        xrbp + (xNMask & (PRIME_X * 2)), yrbp + PRIME_Y, zrbp + (zNMask & (PRIME_Z << 1)), x9, y1, z9);
            }
        }
        ...
        if (!skipD) {
            ...
            if (aD > 0) {
                ...
                value += (aD * aD) * (aD * aD) * grad(seed2,
                        xrbp + (xNMask & (PRIME_X << 1)), yrbp + (yNMask & (PRIME_Y << 1)), zrbp + PRIME_Z, xD, yD, z1);
            }
        }
