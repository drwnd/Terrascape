    ...
    public static short getInInventoryBlockEquivalent(short block) {
        ...
        switch (blockType) {
            ...
            case THIN_BOTTOM_FRONT_STAIR, THIN_BOTTOM_RIGHT_STAIR, THIN_BOTTOM_BACK_STAIR, THIN_BOTTOM_LEFT_STAIR,
                 THIN_TOP_FRONT_STAIR,
                 THIN_TOP_RIGHT_STAIR, THIN_TOP_BACK_STAIR, THIN_TOP_LEFT_STAIR, THIN_FRONT_RIGHT_STAIR,
                 THIN_FRONT_LEFT_STAIR, THIN_BACK_RIGHT_STAIR,
                 THIN_BACK_LEFT_STAIR -> {
            ...
            case THICK_BOTTOM_FRONT_STAIR, THICK_BOTTOM_RIGHT_STAIR, THICK_BOTTOM_BACK_STAIR, THICK_BOTTOM_LEFT_STAIR,
                 THICK_TOP_FRONT_STAIR,
                 THICK_TOP_RIGHT_STAIR, THICK_TOP_BACK_STAIR, THICK_TOP_LEFT_STAIR, THICK_FRONT_RIGHT_STAIR,
                 THICK_FRONT_LEFT_STAIR, THICK_BACK_RIGHT_STAIR,
                 THICK_BACK_LEFT_STAIR -> {
...
//        if (primaryCameraDirection == RIGHT)
    ...
    public static int getBlockTypeOcclusionData(short block, int side) {
        if ((block & 0xFFFF) < STANDARD_BLOCKS_THRESHOLD)
            return BLOCK_TYPE_OCCLUSION_DATA[NON_STANDARD_BLOCK_TYPE[block & 0xFFFF]] & 1 << side;
    ...
    public static void init() {
        ...
        BLOCK_TYPE_OCCLUSION_DATA[BOTTOM_SOCKET] = (byte) 0b10010000;
        BLOCK_TYPE_DATA[BOTTOM_SOCKET] = 0b00111101;

        BLOCK_TYPE_OCCLUSION_DATA[TOP_SOCKET] = (byte) 0b10000010;
        BLOCK_TYPE_DATA[TOP_SOCKET] = 0b00101111;

        BLOCK_TYPE_OCCLUSION_DATA[FRONT_SOCKET] = (byte) 0b10000001;
        BLOCK_TYPE_DATA[FRONT_SOCKET] = 0b00110111;

        BLOCK_TYPE_OCCLUSION_DATA[BACK_SOCKET] = (byte) 0b10001000;
        BLOCK_TYPE_DATA[BACK_SOCKET] = 0b00111110;

        BLOCK_TYPE_OCCLUSION_DATA[LEFT_SOCKET] = (byte) 0b10100000;
        BLOCK_TYPE_DATA[LEFT_SOCKET] = 0b00111011;

        BLOCK_TYPE_OCCLUSION_DATA[RIGHT_SOCKET] = (byte) 0b10000100;
        BLOCK_TYPE_DATA[RIGHT_SOCKET] = 0b00011111;
