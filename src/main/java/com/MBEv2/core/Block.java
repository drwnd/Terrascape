...
//        if (primaryCameraDirection == RIGHT)
    ...
    private static void intiBlockTextures() {
        ...
        NON_STANDARD_BLOCK_TEXTURE_INDICES[SUGAR_CANE] = new byte[]{SUGAR_CANE_TEXTURE};
    ...
    private static void initBlockProperties() {
        ...
        NON_STANDARD_BLOCK_PROPERTIES[SUGAR_CANE] = NO_COLLISION;
    ...
    private static void initNonStandardBlockTypes() {
        ...
        NON_STANDARD_BLOCK_TYPE[SUGAR_CANE] = FLOWER_TYPE;
    }
